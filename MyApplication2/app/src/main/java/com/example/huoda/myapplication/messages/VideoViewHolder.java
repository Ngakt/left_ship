...
public class VideoViewHolder<Message extends IMessage> extends BaseMessageViewHolder<Message>
    ...
    public VideoViewHolder(View itemView, boolean isSender) {
        super(itemView);
        mTextDate = (TextView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_msgitem_date);
        mImageAvatar = (CircleImageView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_iv_msgitem_avatar);
        mImageCover = (ImageView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_iv_msgitem_cover);
        mImagePlay = (ImageView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_iv_msgitem_play);
        mTvDuration = (TextView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_duration);
    }
