...
import com.example.huoda.myapplication.camera.CameraNew;
import com.example.huoda.myapplication.camera.CameraOld;
import com.example.huoda.myapplication.camera.CameraSupport;
...
import com.example.huoda.myapplication.listener.OnMenuClickListener;
import com.example.huoda.myapplication.model.FileItem;
import com.example.huoda.myapplication.model.VideoItem;
import com.example.huoda.myapplication.photo.SelectPhotoView;
import com.example.huoda.myapplication.record.ProgressButton;
import com.example.huoda.myapplication.record.RecordControllerView;
import com.example.huoda.myapplication.record.RecordVoiceButton;
...
public class ChatInputView extends LinearLayout
    ...
    private com.example.huoda.myapplication.ChatInputStyle mStyle;
    ...
    private void init(Context context) {
        mContext = context;
        inflate(context, cn.jiguang.imui.chatinput.R.layout.view_chatinput, this);

        // menu buttons
        mChatInput = (EditText) findViewById(cn.jiguang.imui.chatinput.R.id.aurora_et_chat_input);
    ...
    private OnClickListener onMenuItemClickListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            if (view.getId() == cn.jiguang.imui.chatinput.R.id.aurora_menuitem_ib_send) {
                ...
                } else if (view.getId() == cn.jiguang.imui.chatinput.R.id.aurora_framelayout_menuitem_camera) {
                    if (mListener != null) {
    ...
    private void fullScreen() {
        ...
        mMenuContainer.setLayoutParams(new LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, mHeight));
    ...
    private void triggerSendButtonAnimation(final ImageButton sendBtn, final boolean hasContent,
        ...
        shrinkAnimatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (hasContent) {
                    mSendBtn.setImageDrawable(ContextCompat.getDrawable(getContext(),
                            cn.jiguang.imui.chatinput.R.drawable.aurora_menuitem_send_pres));
                } else {
                    mSendBtn.setImageDrawable(ContextCompat.getDrawable(getContext(),
                            cn.jiguang.imui.chatinput.R.drawable.aurora_menuitem_send));
                }
