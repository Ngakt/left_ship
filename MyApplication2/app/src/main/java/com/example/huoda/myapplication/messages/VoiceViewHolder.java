...
public class VoiceViewHolder<MESSAGE extends IMessage> extends BaseMessageViewHolder<MESSAGE>
    ...
    public VoiceViewHolder(View itemView, boolean isSender) {
        ...
        mMsgTv = (TextView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_msgitem_message);
        mDateTv = (TextView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_msgitem_date);
        mAvatarIv = (CircleImageView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_iv_msgitem_avatar);
        mVoiceIv = (ImageView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_iv_msgitem_voice_anim);

        if (isSender) {
            mLengthTv = (TextView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_tv_voice_length);
        } else {
            mUnreadStatusIv = (ImageView) itemView.findViewById(cn.jiguang.imui.R.id.aurora_iv_msgitem_read_status);
        }
    ...
    public void onBind(final MESSAGE message) {
        ...
        String lengthStr = duration + mContext.getString(cn.jiguang.imui.R.string.aurora_symbol_second);
    ...
    private void playVoice(int position, MESSAGE message, final boolean isSender) {
        ...
        try {
            ...
            Toast.makeText(mContext, mContext.getString(cn.jiguang.imui.R.string.aurora_file_not_found_toast),
