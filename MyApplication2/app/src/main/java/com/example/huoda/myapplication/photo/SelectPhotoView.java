...
public class SelectPhotoView extends FrameLayout implements Handler.Callback {
    ...
    private void init(Context context, AttributeSet attrs) {
        inflate(context, cn.jiguang.imui.chatinput.R.layout.layout_chatinput_selectphoto, this);
        mContext = context;

        mProgressBar = (ProgressBar) findViewById(cn.jiguang.imui.chatinput.R.id.aurora_progressbar_selectphoto);
        mRvPhotos = (RecyclerView) findViewById(cn.jiguang.imui.chatinput.R.id.aurora_recyclerview_selectphoto);
    ...
    public boolean handleMessage(Message message) {
        ...
        if (message.what == MSG_WHAT_SCAN_SUCCESS) {
            ...
            Toast.makeText(getContext(), getContext().getString(cn.jiguang.imui.chatinput.R.string.sdcard_not_prepare_toast),
