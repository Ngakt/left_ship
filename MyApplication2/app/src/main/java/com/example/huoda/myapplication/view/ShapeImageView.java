package com.example.huoda.myapplication.view;
...
public class ShapeImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, cn.jiguang.imui.R.styleable.MessageList);
            mRadius = a.getDimension(cn.jiguang.imui.R.styleable.MessageList_videomessage_radius, 0);
            a.recycle();
        }
        mPaint = new Paint();
