package com.example.huoda.myapplication.model;

import android.support.annotation.NonNull;

import java.text.NumberFormat;

public class FileItem implements Comparable<com.example.huoda.myapplication.model.FileItem> {
    ...
    @Override
    public int compareTo(@NonNull cn.jiguang.imui.chatinput.model.FileItem fileItem) {
