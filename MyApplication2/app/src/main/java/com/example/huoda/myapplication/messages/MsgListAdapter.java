...
public class MsgListAdapter<MESSAGE extends IMessage> extends RecyclerView.Adapter<ViewHolder>
    ...
    public static class HoldersConfig {
        ...
        public HoldersConfig() {
            ...
            mSendTxtLayout = cn.jiguang.imui.R.layout.item_send_text;
            mReceiveTxtLayout = cn.jiguang.imui.R.layout.item_receive_txt;

            mSendVoiceLayout = cn.jiguang.imui.R.layout.item_send_voice;
            mReceiveVoiceLayout = cn.jiguang.imui.R.layout.item_receive_voice;

            mSendPhotoLayout = cn.jiguang.imui.R.layout.item_send_photo;
            mReceivePhotoLayout = cn.jiguang.imui.R.layout.item_receive_photo;

            mSendVideoLayout = cn.jiguang.imui.R.layout.item_send_video;
            mReceiveVideoLayout = cn.jiguang.imui.R.layout.item_receive_video;
        }
